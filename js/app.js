...
window.TF={nav:nav,subNav:subNav,load:loadData,start:tmrStart,pause:tmrPause,done:tmrDone,addTimeToTask:addTimeToTask,addTask:addTask,quickAdd:quickAdd,openAddModal:openAddModal,
  ...
  refreshEcReview:refreshEcReview,dismissEcReview:dismissEcReview,_crModeChange:_crModeChange,_crClientAc:_crClientAc,_crClientKey:_crClientKey,_crClientSelect:_crClientSelect,_crSubmit:_crSubmit,
