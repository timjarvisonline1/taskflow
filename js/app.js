...
window.TF={nav:nav,subNav:subNav,load:loadData,start:tmrStart,pause:tmrPause,done:tmrDone,addTimeToTask:addTimeToTask,addTask:addTask,quickAdd:quickAdd,openAddModal:openAddModal,
  ...
  scanEcReview:scanEcReview,dismissEcReview:dismissEcReview,openContactReviewModal:openContactReviewModal,_crModeChange:_crModeChange,_crClientChange:_crClientChange,_crSubmit:_crSubmit,
